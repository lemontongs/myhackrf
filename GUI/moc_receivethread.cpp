...
QT_MOC_LITERAL(3, 25, 6)
    ...
    "ReceiveThread\0newPacket\0\0packet"
};
...
void ReceiveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newPacket((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ReceiveThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ReceiveThread::newPacket)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ReceiveThread::newPacket(QString _t1)
{
